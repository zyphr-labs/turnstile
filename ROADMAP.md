...
The first release is a small guardrail engine and a scoped Claude Code adapter. Future work should follow evidence from normal use rather than a target integration count.
...
- Validate a second endpoint agent and an application integration against the same decision contract.
